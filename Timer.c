...
IODIR0 = 0X000FF000; //To set all pins as OUTPUT
while(1)
{
IOSET1 = 0X000AA000; //To glow alternate LED'S from P1.24 to P1.31
delay(1000);
IOCLR1 = 0X000AA000; //To make alternate LED'S off from P1.24 to P1.31
delay(1000);
for(i=24;i<=31;i++)
{
IOSET1 = 1<<i;
